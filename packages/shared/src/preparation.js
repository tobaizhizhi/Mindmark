...
import { PrepareJourneyRequestSchema, SourcePageSchema, SourceChunkContentSchema, } from "./schemas.js";
import { hashGoal, hashSourceChunk, hashSourcePages } from "./hash.js";
import { normalizeSourceText } from "./citations.js";
function selectChunkCount(pageCount, totalCharacters) {
    if (pageCount >= 9 || totalCharacters >= 12_000)
        return 4;
    if (pageCount >= 6 || totalCharacters >= 4_500)
        return 3;
    return 2;
}
